...
class database:
        ...
        def create_data(self):
            ...
            df.to_csv (r'C:\Users\clead\Documents\ING5\ECE\PFE\PPE\PPE\regression.csv', index = False, header=True)
        ...
        def all_epci(self, df):
            ...
            epci_data.to_csv(r'C:\Users\clead\Documents\ING5\ECE\PFE\PPE\PPE\all_epci.csv', index = False, header=True)
            return epci_data
        ...
        def all_county(self, df):
            ...
            county_data.to_csv(r'C:\Users\clead\Documents\ING5\ECE\PFE\PPE\PPE\all_county.csv', index = False, header=True)
            return county_data
